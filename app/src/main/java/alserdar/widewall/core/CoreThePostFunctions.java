...
public class CoreThePostFunctions {

    public static void countPost(final String mainKey , String countKey , final TextView countReplies , final TextView countAdds ,
                                 final TextView countLikes , final TextView countFavs ,
                                 final TextView countListeners) {

        FirebaseDatabase db = FirebaseDatabase.getInstance();
        DatabaseReference doc = db.getReference("countPost " + mainKey).child(countKey);
    ...
    // repost or add posts =========================
    public static void repostOrNot(String theUID , final String keyPost , final ImageView add, final ImageView unAdd) {
    ...
    public static void repostMethod(final String theUID ,final String thePosterUID , final String posterCountry , final String mainKeyPost ,
                                    final String keyPost , final String countKey  , final ImageView add ,
                                    final ImageView unAdd , final String typeMessage ,
                                    final String myNickName , final String handle ,
                                    final String getTheRandom , final String audioStatus ) {
        ...
        doc.setValue(new PostModel(thePosterUID, typeMessage , myNickName,
                handle, posterCountry, posterCountry , "Planet", audioStatus,
                "picPath", getTheRandom, mainKeyPost, keyPost , countKey,
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isComplete())
                {
                    add.setVisibility(View.GONE);
                    unAdd.setVisibility(View.VISIBLE);
                    setPlusAndMinusTheRePost("increaseScore" , countKey , mainKeyPost);
                }
            }
        });
    ...
    public static void unRepostMethod(final String theUID , final String hisUID , final String mainKey , final String postKey , final String countKey , final ImageView unAdd , final ImageView add) {
        ...
        applesQuery.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot appleSnapshot: dataSnapshot.getChildren()) {
                    ...
                    setPlusAndMinusTheRePost("decreaseScore" , countKey , mainKey);
                }
            }
        ...
        DatabaseReference refNotification = FirebaseDatabase.getInstance().getReference();
        Query applesQueryNotification = refNotification.child(hisUID).child("notifications").orderByChild("thePostKey").equalTo(postKey);

        applesQueryNotification.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot appleSnapshot: dataSnapshot.getChildren()) {
                    appleSnapshot.getRef().removeValue();
    ...
    private static void setPlusAndMinusTheRePost(final String operation , final  String countKeyPost , final String mainKey) {
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("countPost " +mainKey);
        ref.runTransaction(new Transaction.Handler() {
            @NonNull
            @Override
    ...
    public static void likeMethod(final String theUID , final String theposterUID , String whichRoom , final String theposterCountry , final String mainKeyPost ,
                                  final String keyPost , final String countKey , final ImageView like ,
                                  final ImageView unlike , final String typeMessage ,
                                  final String myNickName , final String handle ,
                                  final String getTheRandom , final String audioStatus , String picPath ) {


        FirebaseDatabase db = FirebaseDatabase.getInstance();
        final DatabaseReference doc = db.getReference(theUID).child("likes").push();
        doc.setValue(new PostModel(theposterUID, typeMessage , myNickName,
                handle, theposterCountry, theposterCountry , whichRoom, audioStatus,
                picPath, getTheRandom, mainKeyPost, keyPost , countKey,
                false, returnTheDate() , returnTheTime() , "" , keyPost , "")).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isComplete())
                {
                    like.setVisibility(View.GONE);
                    unlike.setVisibility(View.VISIBLE);
                    setPlusAndMinusThePostLikes("increaseScore" , countKey , mainKeyPost);
                }
            }
        });
    ...
    public static void unLikeMehod(final String theUID , final String hisUID , final String mainKey , final String postKey , final String countKey ,
        ...
        applesQuery.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot appleSnapshot: dataSnapshot.getChildren()) {
                    ...
                    setPlusAndMinusThePostLikes("decreaseScore" , countKey , mainKey);
                }
            }
    ...
    private static void setPlusAndMinusThePostLikes(final String operation , final  String countKeyPost , final String mainKey) {
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("countPost " +mainKey);
        ref.runTransaction(new Transaction.Handler() {
            @NonNull
            @Override
    ...
    public static void favMethod(final String theUID , final String theposterUID , String whichRoom , final String theposterCountry ,
                                 final String mainKeyPost , final String keyPost , final String countKey , final ImageView fav ,
        ...
        doc.setValue(new PostModel(theposterUID, typeMessage , myNickName,
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isComplete())
                {
                    fav.setVisibility(View.GONE);
                    unFav.setVisibility(View.VISIBLE);
                    setPlusAndMinusThePostFav("increaseScore" , countKey , mainKeyPost);
                }
            }
        });
    ...
    public static void unFavMehod(final String theUID , final String mainKey, final String postKey , final String countKey ,
        ...
        applesQuery.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot appleSnapshot: dataSnapshot.getChildren()) {
                    ...
                    setPlusAndMinusThePostFav("decreaseScore" , countKey , mainKey);
                }
            }
    ...
    private static void setPlusAndMinusThePostFav(final String operation , final  String countKeyPost , final String mainKey) {
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("countPost " +mainKey);
        ref.runTransaction(new Transaction.Handler() {
            @NonNull
            @Override
    ...
    /// listen method ============================================================
    public static void listenedOrNotMethod(final String thePosterUID , final String thePosterNickname
            , final String thePosterHandle , final String thePost, final String countKey , final String keyPost ,
                                           final String listenerUID ,
                                           final String listenerNickname , final String listenerHandle ,
                                           final String audioStatus , final String picPath , final String audioPath) {

        DatabaseReference listenedOrNot = FirebaseDatabase.getInstance().getReference(listenerUID).child("listened");
        listenedOrNot.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists())
                {
                    for(DataSnapshot ds : dataSnapshot.getChildren())
                    {
                        if (ds.child("keyPost").getValue().equals(keyPost))
                        {

                        }else
                        {

                            CoreThePost.CoreTheListen(listenerUID ,thePosterNickname  , thePosterHandle ,
                                    keyPost , listenerUID , listenerNickname , listenerHandle);

                            setPlusAndMinusThePostListen(countKey , keyPost);

                            CoreTheNotificationsList.NotificationForListen(thePosterUID ,thePosterNickname  , thePosterHandle ,
                                     thePost ,  keyPost , "planet" , listenerUID , listenerNickname , listenerHandle,
    ...
    public static void listenMethod(final String theUID , final String mainKeyPost ,
                                 final String keyPost , final String countKey , final String typeMessage ,
                                 final String myNickName , final String handle ,
                                 final String getTheRandom , final String audioStatus ) {

        FirebaseDatabase db = FirebaseDatabase.getInstance();
        final DatabaseReference doc = db.getReference(theUID).child("listen").push();
        doc.setValue(new PostModel(theUID, typeMessage , myNickName,
                handle, "currentCountry", "PostCountry" , "Planet", audioStatus,
                "picPath", getTheRandom, mainKeyPost, keyPost , countKey,
                false,  returnTheDate() , returnTheTime() , "" , "" , keyPost)).addOnCompleteListener(new OnCompleteListener<Void>() {
    ...
    private static void setPlusAndMinusThePostListen(final  String countKeyPost , final String mainKey) {
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("countPost " +mainKey);
        ref.runTransaction(new Transaction.Handler() {
            @NonNull
            @Override
            public Transaction.Result doTransaction(@NonNull MutableData mutableData) {
                ...
                for (MutableData md : mutableData.getChildren())
                {
                    ...
                    assert countModel != null;
                    mutableData.child(countKeyPost).child("countListeners").setValue(countModel.getCountListeners() + 1);
