...
public class FirebaseBackgroundServiceForNotifications extends Service {
    ...
    {
        FirebaseApp.initializeApp(FirebaseBackgroundServiceForNotifications.this);

        FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance();
        final DatabaseReference reference =  firebaseDatabase.getReference(notificationThatUid).child("notifications");
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
                if (dataSnapshot.exists())
                {
                    for (DataSnapshot ds : dataSnapshot.getChildren())
                    {
                        ...
                        if (model != null) {
                            if (model.getNotificationerUID().equals(model.getThePosterUID()))
                            {

                            }else
                            {
                                postNotif(getString(R.string.new_notification_from) + " " + model.getNotificationerName() , getBaseContext());
